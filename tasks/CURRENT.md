...
当前阶段：内置资产试用版的 PostgreSQL 迁移与 Cloudflare 运行时改造。线上导航及本机能力收口已完成，待连接 Supabase 执行基线/种子，并在 Cloudflare Linux 构建中验证 Workers 打包。原始资料、文件导入、PDF 解析与 OCR 不属于本次线上发布范围。
